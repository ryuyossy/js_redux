...
class PotentialCustomerSearchHandler extends BaseComponent {
  ...
  submitForm(){
    ...
    var phoneNumber = React.findDOMNode(this.refs.phone_number).value;
    ...
    if (!clientNo && !phoneNumber && !firstName && !lastName) {
      ...
      }, 1000, `/potential_customers_search_result`, values);
    }
  }
    ...
    return (
      <div className="contentPanel">
        <div className="panel-heading">
          ...
          <div><strong>Potential client search</strong></div>
        </div>
        <div className="searchClient">
          <div className="row">
            <div className="col s3">
              <div className="fName" ref="errorsBoxCn">
                <input type="text" placeholder="Potential Client No" ref="client_no" id="client_no" onChange={this.onChangeValue}/>
              </div>
...
export default PotentialCustomerSearchHandler;
