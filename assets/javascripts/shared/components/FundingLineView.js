...
class FundingLineView extends BaseComponent {
  ...
  handleDelete(e) {
    this.props.actions.deleteFundingLine(this.props.fundingLine.id)
  }
  ...
  handleKeyDown(e){
    ...
    if(key == 13){ //enter
      ...
      this.props.actions.updateFundingLine(this.props.id,values);
  ...
  render() {
    ...
    let fundingLine = this.props.fundingLine;
    ...
    if(this.state.text_pressed || this.props.errors){
        ...
        <div>
          <div className="row">
             <div className="input-field col s6">
               <input onKeyDown={this.handleKeyDown}  ref="funding_source_name" defaultValue={fundingLine.funding_source_name} id="funding_source_name" type="text" className="validate" />
      ...
      result = (<div className={border}>
        <div className="col s2" onClick={this.handleEdit}>
          {this.props.fundingLine.funding_source_name}
        </div>
...
export default FundingLineView;
